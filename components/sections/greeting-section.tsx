...
export default function GreetingSection() {
  return (
    <section className="py-16 md:py-24 bg-[#f0f4f8] relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-64 h-64 bg-[#2b5ea7]/20 rounded-full mix-blend-multiply filter blur-3xl animate-pulse-soft -translate-y-1/2 translate-x-1/2" />
      ...
      <div className="absolute top-1/2 right-1/4 w-32 h-32 bg-[#1a2744]/10 rounded-full mix-blend-multiply filter blur-2xl animate-pulse-soft" style={{ animationDelay: "1s" }} />

      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto bg-white rounded-3xl p-6 md:p-12 shadow-xl border-4 border-white ring-4 ring-[#2b5ea7]/20">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="w-full md:w-3/5 text-center md:text-left">
              <div className="mb-6 inline-block">
                <span className="bg-blue-100 text-[#2b5ea7] px-4 py-1 rounded-full text-sm font-bold mb-2 inline-block">
                  ごあいさつ
                </span>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-800 leading-snug">
                  「ちょっと見てほしい」
                  <br />
                  <span className="text-[#2b5ea7] bg-blue-50 px-2 rounded-lg">
                    気軽に頼れる
                  </span>
                  <br />
                  町の電気屋さんでありたい
