...
export default function GreetingSection() {
  return (
    <section className="py-16 md:py-24 bg-[#1a2744] relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-[#2b5ea7]/20 rounded-full filter blur-3xl animate-pulse-soft -translate-y-1/2 translate-x-1/2" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#2b5ea7]/15 rounded-full filter blur-3xl animate-pulse-soft translate-y-1/2 -translate-x-1/2" style={{ animationDelay: "2s" }} />
      <div className="absolute top-1/2 right-1/4 w-32 h-32 bg-white/5 rounded-full filter blur-2xl animate-pulse-soft" style={{ animationDelay: "1s" }} />

      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto bg-white/10 backdrop-blur rounded-3xl p-6 md:p-12 shadow-xl border border-white/20">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="w-full md:w-3/5 text-center md:text-left">
              ...
              <div className="mt-8 pt-6 border-t border-white/20 flex items-center justify-center md:justify-end gap-2 text-gray-400">
                <PenTool size={16} />
